  ...
  return (
    <div className="pt-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="font-bold text-lg">Threshold Settings</h2>
        <button
          onClick={onClose}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-bold">pH Level</h3>
          ...
          {errors.ph && <p className="text-xs font-bold mt-1">{errors.ph}</p>}
        </div>

        {/* Temperature Thresholds */}
        <div className="space-y-3">
          <h3 className="text-sm font-bold">Temperature (°C)</h3>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs text-gray-600 mb-2">
                Minimum
          ...
          {errors.temperature && (
            <p className="text-xs font-bold mt-1">{errors.temperature}</p>
          )}
        </div>

        {/* TDS Thresholds */}
        <div className="space-y-3">
          <h3 className="text-sm font-bold">TDS Level (ppm)</h3>
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs text-gray-600 mb-2">
                Minimum
          ...
          {errors.tds && <p className="text-xs font-bold mt-1">{errors.tds}</p>}
        </div>
      </div>
      ...
      <button
        onClick={handleSave}
        className="w-full mt-6 bg-black text-white py-2.5 px-4 border-2 border-black flex items-center justify-center gap-2 hover:bg-gray-800 transition-colors text-sm font-bold"
      >
